...
private[tagless] trait InvariantKPrivate {
  private[tagless] trait Nat2UnorderedFoldable[F[_], G[_]] extends UnorderedFoldable[G] {
  ...
  private[tagless] trait Nat2Foldable[F[_], G[_]] extends Foldable[G] with Nat2UnorderedFoldable[F, G] {
    def F: Foldable[F]

...
object SemigroupalKInstances extends SemigroupalKInstances
...
trait SemigroupalKInstances09 extends SemigroupalKTraits
...
trait SemigroupalKTraitsPrivate {
  
  sealed trait Tup2KSemigroupal[F[_], G[_]] extends Semigroupal[Tuple2K[F, G, ?]] {
    def F: Semigroupal[F]
    def G: Semigroupal[G]
  ...
  sealed trait Tup2KInvariant[F[_], G[_]] extends Invariant[λ[α => Tuple2K[F, G, α]]] {
    def F: Invariant[F]
    def G: Invariant[G]
  ...
  sealed trait Tup2KFunctor[F[_], G[_]] extends Functor[λ[α => Tuple2K[F, G, α]]] {
    def F: Functor[F]
    def G: Functor[G]
  ...
  sealed trait Tup2KContravariant[F[_], G[_]] extends Contravariant[λ[α => Tuple2K[F, G, α]]] {
  ...
  sealed trait Tup2KDistributive[F[_], G[_]] extends Distributive[λ[α => Tuple2K[F, G, α]]] with Tup2KFunctor[F, G] {
  ...
  sealed trait Tup2KContravariantMonoidal[F[_], G[_]]
  ...
  sealed trait Tup2KApply[F[_], G[_]] extends Apply[λ[α => Tuple2K[F, G, α]]] with Tup2KFunctor[F, G] {
    def F: Apply[F]
    def G: Apply[G]
  ...
  sealed trait Tup2KContravariantSemigroupal[F[_], G[_]]
  ...
  sealed trait Tup2KInvariantSemigroupal[F[_], G[_]]
  ...
  sealed trait Tup2KInvariantMonoidal[F[_], G[_]]
  ...
  sealed trait Tup2KApplicative[F[_], G[_]]
  ...
  sealed trait Tup2KSemigroupK[F[_], G[_]] extends SemigroupK[λ[α => Tuple2K[F, G, α]]] {
    def F: SemigroupK[F]
    def G: SemigroupK[G]
  ...
  sealed trait Tup2KMonoidK[F[_], G[_]]
  ...
  sealed trait Tup2KAlternative[F[_], G[_]]
  ...
  sealed trait Tup2KFlatMap[F[_], G[_]]
  ...
  sealed trait Tup2KMonad[F[_], G[_]]
  ...
  sealed trait Tup2KFoldable[F[_], G[_]] extends Foldable[λ[α => Tuple2K[F, G, α]]] {
    def F: Foldable[F]
    def G: Foldable[G]
  ...
  sealed trait Tup2KUnorderedFoldable[F[_], G[_]] extends UnorderedFoldable[λ[α => Tuple2K[F, G, α]]] {
  ...
  sealed trait Tup2KTraverse[F[_], G[_]]
  ...
  sealed trait Tup2KUnorderedTraverse[F[_], G[_]]
    ...
    def unorderedTraverse[H[_], A, B](
      fa: Tuple2K[F, G, A]
    )(f: A => H[B])(implicit H: CommutativeApplicative[H]): H[Tuple2K[F, G, B]] =
